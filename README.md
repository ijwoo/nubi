...
같은 태스크 3개를 두 실행기로 5회씩, 시뮬레이터에서 잰 결과입니다.
...
**속도 차이는 1.3~1.5배로, 극적이지 않습니다.** 두 실행기가 같은 기기를 쓰기 때문입니다 — 앱 실행 4~5초는 모델이 없어도 그대로입니다. 재생이 의미 있는 쪽은 비용입니다: 하루 20번 쓰는 동작이면 탐색만으로 월 $8~14, 매크로로 굳히면 $0입니다.
